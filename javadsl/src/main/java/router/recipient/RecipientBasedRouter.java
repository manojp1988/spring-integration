...
@DirtiesContext
public class RecipientBasedRouter {
    ...
    public IntegrationFlow routerFlow() {
      return IntegrationFlows.from("testChannel")
                             .routeToRecipients(new Consumer<RecipientListRouterSpec>() {
                               public void accept(RecipientListRouterSpec t) {
                                 t.recipient("helloChannel");
                                 t.recipient("welcomeChannel");
                                 t.recipient("defaultOutputChannel");
